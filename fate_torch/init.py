import copy
import inspect
from fate_torch.torch_modules_extract.extract_pytorch_modules import Required
from torch.nn import init as torch_init
import functools
from fate_torch.nn import FateTorchLayer
...
def run_init(torch_initializer, input_var, init, layer):
    ...
    if isinstance(layer, Sequential):
        ...
        raise ValueError('only instances of FateTorchLayer can be initialized by init functions')
